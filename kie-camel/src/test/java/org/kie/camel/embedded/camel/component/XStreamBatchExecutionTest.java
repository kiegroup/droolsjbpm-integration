...
import org.kie.camel.embedded.camel.testdomain.TestVariable;
...
public class XStreamBatchExecutionTest extends CamelTestSupport {
    ...
    public void testListenForChanges() throws Exception {
        ...
        inXml += "    <org.kie.camel.embedded.camel.testdomain.Cheese>";
        ...
        inXml += "    <org.kie.camel.embedded.camel.testdomain.Person>";
        inXml += "      <name>mic</name>";
        inXml += "    </org.kie.camel.embedded.camel.testdomain.Person>";
        inXml += "  </insert>";
        inXml += "  <insert out-identifier='changes'>";
        inXml += "    <org.kie.camel.embedded.camel.testdomain.ChangeCollector/>";
        inXml += "  </insert>";
        inXml += "  <fire-all-rules />";
        inXml += "</batch-execution>";
    ...
    public void FIXME_testQuery() throws Exception {
        ...
        expectedXml += "      <row>\n";
        row = it2.next();
        expectedXml += "        <org.kie.camel.embedded.camel.testdomain.Cheese reference=\"../../../../result/query-results/row/org.kie.camel.embedded.camel.testdomain.Cheese\"/>\n";
        expectedXml += "        <fact-handle external-form='" + row.getFactHandle("stilton").toExternalForm() + "' />";
        expectedXml += "        <org.kie.camel.embedded.camel.testdomain.Cheese reference=\"../../../../result/query-results/row/org.kie.camel.embedded.camel.testdomain.Cheese[2]\"/>\n";
        expectedXml += "        <fact-handle external-form='" + row.getFactHandle("cheddar").toExternalForm() + "' />";
        expectedXml += "      </row>\n";
        expectedXml += "      <row>\n";
        row = it2.next();
        expectedXml += "        <org.kie.camel.embedded.camel.testdomain.Cheese reference=\"../../../../result/query-results/row[2]/org.kie.camel.embedded.camel.testdomain.Cheese\"/>\n";
        expectedXml += "        <fact-handle external-form='" + row.getFactHandle("stilton").toExternalForm() + "' />";
        expectedXml += "        <org.kie.camel.embedded.camel.testdomain.Cheese reference=\"../../../../result/query-results/row[2]/org.kie.camel.embedded.camel.testdomain.Cheese[2]\"/>\n";
        expectedXml += "        <fact-handle external-form='" + row.getFactHandle("cheddar").toExternalForm() + "' />";
        expectedXml += "      </row>\n";
        expectedXml += "    </query-results>\n";
        expectedXml += "  </result>\n";
    ...
    public void testProcess() throws SAXException, IOException {
        ...
        str += "  <header>\n";
        str += "    <imports>\n";
        str += "      <import name=\"org.kie.camel.embedded.camel.testdomain.TestVariable\" />\n";
        str += "    </imports>\n";
        str += "    <globals>\n";
        ...
        inXml += "       <org.kie.camel.embedded.camel.testdomain.TestVariable>";
    ...
    public void testCompleteWorkItem() {
        ...
        str += "      </variable>\n";
        str += "      <variable name=\"Person\" >\n";
        str += "        <type name=\"org.drools.core.process.core.datatype.impl.type.ObjectDataType\" className=\"org.kie.camel.embedded.camel.testdomain.Person\" />\n";
        str += "      </variable>\n";
    ...
    public void testExecutionNodeLookup() throws Exception {
        ...
        inXml += "  <insert out-identifier='outStilton'>";
        inXml += "    <org.kie.camel.embedded.camel.testdomain.Cheese1>";
        inXml += "      <type>stilton</type>";
        inXml += "      <price>25</price>";
        inXml += "      <oldPrice>0</oldPrice>";
        inXml += "    </org.kie.camel.embedded.camel.testdomain.Cheese1>";
        ...
        inXml2 += "    <org.kie.camel.embedded.camel.testdomain.Cheese2>";
