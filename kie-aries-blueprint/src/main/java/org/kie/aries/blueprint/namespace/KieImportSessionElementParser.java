...
public class KieImportSessionElementParser extends AbstractElementParser {

    @Override
    public ComponentMetadata parseElement( ParserContext context, Element element ) {
        String ksessionName = element.getAttribute("name");
        ...
        beanMetadata.setFactoryMethod("createImportedKieSession");
        beanMetadata.setId(ksessionName);
        beanMetadata.addArgument(createValue(context, ksessionName),null,0);
