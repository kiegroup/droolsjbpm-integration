...
import net.pmml.tester.regression.CategoricalVariablesRegressionExecutor;
import net.pmml.tester.regression.CategoricalVariablesRegressionTest;
import net.pmml.tester.regression.LogisticRegressionIrisDataExecutor;
import net.pmml.tester.regression.LogisticRegressionIrisDataTest;
import net.pmml.tester.scorecard.CompoundNestedPredicateScorecardExecutor;
import net.pmml.tester.scorecard.CompoundNestedPredicateScorecardTest;
import net.pmml.tester.scorecard.SimpleScorecardCategoricalExecutor;
import net.pmml.tester.scorecard.SimpleScorecardCategoricalTest;
