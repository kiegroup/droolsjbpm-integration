...
public class BatchFluentBuilderImp extends BaseBatchFluent<BatchBuilderFluent> implements BatchBuilderFluent {
    ...
    public KieContainerBatchFluent getKieContainer(ReleaseId releaseId) {
        ...
        KieContainerBatchFluentImpl fluent = new KieContainerBatchFluentImpl(fluentCtx, releaseId);
        return fluent;
    }

    @Override
    public BatchBuilderFluent newApplicationContext(String name) {
        addCommand(new NewContextCommand(name));
        return this;
    }

    @Override
    public BatchBuilderFluent getApplicationContext(String name) {
