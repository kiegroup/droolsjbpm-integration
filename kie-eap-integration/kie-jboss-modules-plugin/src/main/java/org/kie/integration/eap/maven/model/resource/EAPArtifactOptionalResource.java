...
public class EAPArtifactOptionalResource extends EAPArtifactResource {
    ...
    protected EAPArtifactOptionalResource(String name) {
        super(name);
    }
    ...
    public static EAPArtifactOptionalResource create(Artifact artifact) {
        ...
        EAPArtifactOptionalResource result = new EAPArtifactOptionalResource(EAPArtifactUtils.getArtifactCoordinates(artifact));
