...
public class EAPUnresolvableArtifactResource extends EAPArtifactResource {
    ...
    protected EAPUnresolvableArtifactResource(String name) {
        super(name);
    }
    ...
    public static EAPArtifactResource create(Artifact artifact) {
        ...
        EAPArtifactResource result = new EAPUnresolvableArtifactResource(EAPArtifactUtils.getArtifactCoordinates(artifact));
