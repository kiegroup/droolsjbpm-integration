...
public class PlannerCloudBalanceIntegrationTest extends AbstractKarafIntegrationTest {
    ...
    public void plannerSolverFactoryTest() throws IOException {
        InputStream stream = this.getClass().getResourceAsStream(CLOUD_BALANCE_INCREMENTAL_CONFIG_FILE);
        SolverFactory solverFactory = SolverFactory
                .createFromXmlInputStream(stream, PlannerCloudBalanceIntegrationTest.class.getClassLoader());
        stream.close();
    ...
    public void plannerSolverFactoryDroolsTest() throws IOException {
        SolverFactory solverFactory = SolverFactory
                .createFromXmlResource(CLOUD_BALANCE_DROOLS_CONFIG_FILE,
                                       PlannerCloudBalanceIntegrationTest.class.getClassLoader());
