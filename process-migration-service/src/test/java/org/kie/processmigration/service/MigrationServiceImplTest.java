...
public class MigrationServiceImplTest extends PersistenceTest {

    @Rule
    public WeldInitiator weld = WeldInitiator
                                             .from(PlanServiceImpl.class, MigrationServiceImpl.class)
    ...
    @Test
    public void testSubmitMigration() throws InvalidMigrationException {
        // Given
        ...
        def.setKieserverId("test-kie-server");
        def.setExecution(Execution.SYNC);
        ...
        // Then
        List<Migration> plans = migrationService.findAll();
