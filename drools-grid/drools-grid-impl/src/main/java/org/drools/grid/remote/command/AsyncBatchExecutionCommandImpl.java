...
public class AsyncBatchExecutionCommandImpl implements BatchExecutionCommand, GenericCommand<ExecutionResults> {
    ...
    public AsyncBatchExecutionCommandImpl( List<Command> commands ) {
        List<GenericCommand<?>> genericCmds = new ArrayList<GenericCommand<?>>();
    ...
    public AsyncBatchExecutionCommandImpl( List<GenericCommand<?>> commands, String lookup ) {
