 ...
 * @author salaboy
 */
public class DirectoryLookupProviderGridClient
    implements
    ...
    public DirectoryLookupProviderGridClient(GenericNodeConnector connector,
    ...
    public void register(String identifier,
        ...
        try {
            ...
            Message msg = new Message( this.messageSession.getSessionId(),
                                       ...
                                       new KnowledgeContextResolveFromContextCommand(
                                                                                      new RegisterCommand( identifier,
                                                                                                           ((StatefulKnowledgeSessionGridClient) executor)
                                                                                                                   .getInstanceId(),
                                                                                                           type ),
                                                                                      null,
                                                                                      null,
            ...
            for ( DirectoryNode directory : this.connection.getDirectoryNodes() ) {
                try {
                    try {

                        directory.get( DirectoryNodeService.class ).register( identifier,
                                                                              this.currentConnector.getId() );
                    } catch ( RemoteException ex ) {
                        Logger.getLogger( DirectoryLookupProviderGridClient.class.getName() ).log( Level.SEVERE,
                                                                                                   null,
                                                                                                   ex );
                    }
            ...
            try {
                Object object = this.currentConnector.write( msg ).getPayload();
        ...
        try {
            ...
            for ( DirectoryNode directory : this.connection.getDirectoryNodes() ) {
                ...
                try {
                    ...
                    this.currentConnector = GenericConnectorFactory.newConnector( connectorString );
