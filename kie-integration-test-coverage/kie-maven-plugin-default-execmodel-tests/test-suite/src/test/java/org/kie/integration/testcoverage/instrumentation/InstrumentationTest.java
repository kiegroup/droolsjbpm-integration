...
public class InstrumentationTest {
    ...
    private static final ReleaseId RELEASE_ID = KIE_SERVICES.newReleaseId("org.drools.testcoverage", "kjar-with-instrumentation-default-execmodel", TestUtil.getProjectVersion());
    ...
    /*
     * There is no need to check the files:
     * META-INF/kmodule.info
     * META-INF/instrumentationKBase/kbase.cache
     * useless and not generated when using the executable model 
     */
}
