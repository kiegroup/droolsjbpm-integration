...
@Config(manifest = "src/main/AndroidManifest.xml",
        shadows = {ShadowMultiDexClassLoader.class,
                ShadowDexClassLoader.class,
                ShadowBaseDexClassLoader.class})
public class DroolsActivityTest {
    ...
    public void testInjection() throws Exception {
        DroolsAndroidContext.setContext(RuntimeEnvironment.application);
