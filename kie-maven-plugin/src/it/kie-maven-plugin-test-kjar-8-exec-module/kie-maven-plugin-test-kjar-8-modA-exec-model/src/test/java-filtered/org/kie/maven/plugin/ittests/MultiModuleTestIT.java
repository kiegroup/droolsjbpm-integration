...
public class MultiModuleTestIT {
    ...
    private final static String GAV_ARTIFACT_ID = "kie-maven-plugin-test-kjar-8-modA-exec-model";
    ...
    public void testMultiModule() throws Exception {
        ...
        try {
            kContainer = (KieContainerImpl)  kieServices.getKieClasspathContainer(projectClassLoader);
