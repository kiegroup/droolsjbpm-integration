...
abstract public class AbstractKarafIntegrationTest {
    ...
    public static MavenArtifactProvisionOption getFeaturesUrl(String groupId, String artifactId, String version) {
        ...
        if (System.getProperty("drools.features.classifier") != null && "drools-karaf-features".equals(artifactId)) {
            classifier = System.getProperty("drools.features.classifier");
        }
    ...
    public static Option loadKieFeaturesRepo() {
        String classifier = "features";
        if (System.getProperty("drools.features.classifier") != null) {
            classifier = System.getProperty("drools.features.classifier");
        }
        return features(maven().groupId("org.drools")
                .artifactId("drools-karaf-features")
                .type("xml")
