...
public class RemoteClientKarafIntegrationJaxbIntegrationTest extends BaseRemoteClientOnKarafIntegrationTest {

    public static final String HOST = "localhost";
    public static final int PORT = 59400;

    public RemoteClientKarafIntegrationJaxbIntegrationTest() {
