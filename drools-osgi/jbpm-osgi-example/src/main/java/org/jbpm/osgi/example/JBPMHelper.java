...
public final class JBPMHelper {
    ...
    public void startUp() {
        ...
        if ("true".equals(persistenceEnabled) || "true".equals(humanTaskEnabled)) {
            //JBPMHelper.this.setupDataSource();
        }
        if ("true".equals(humanTaskEnabled)) {
           JBPMHelper.this.startTaskService();
        }
    }

    public Server startH2Server() {
        try {
    ...
    public TaskService startTaskService() {
        Properties properties = getProperties();
        ...
        */
        ...
        HumanTaskServiceFactory.setEntityManagerFactory(this.emf);
