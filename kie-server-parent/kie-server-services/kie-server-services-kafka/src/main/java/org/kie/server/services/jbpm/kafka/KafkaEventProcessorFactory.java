...
public interface KafkaEventProcessorFactory {
    ...
    /**
     * Return a KafkaEventReader to be used for the provided topic and classloader 
     * @param topic name of the topic
     * @param cl must be used to load classes
     * @return KafkaEventReader instance, which might a newly created instance or
     * an already existing one 
     */
    KafkaEventReader getEventReader(String topic, ClassLoader cl);

    /**
     * Return a KafkaEventWriter to be used for the provided topic  
     * @param topic name of the topic
    ...
    /**
     * Cleanup resources hold by factory, if any (for example, a EventReader instance cache)
     */
    default void close() {}
