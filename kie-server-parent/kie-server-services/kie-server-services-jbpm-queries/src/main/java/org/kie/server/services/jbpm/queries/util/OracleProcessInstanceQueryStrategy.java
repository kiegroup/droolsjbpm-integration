...
public class OracleProcessInstanceQueryStrategy implements QueryStrategy {

	private static final Logger logger = LoggerFactory.getLogger(OracleProcessInstanceQueryStrategy.class);
