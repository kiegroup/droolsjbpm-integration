...
public class H2ProcessInstanceQueryStrategy implements QueryStrategy {
	
	private static final Logger logger = LoggerFactory.getLogger(H2ProcessInstanceQueryStrategy.class);
