...
public class ProcessInstanceQueryServiceBase extends AbstractQueryServiceBase {
	...
	public ProcessInstanceQueryServiceBase(QueryService queryService, KieServerRegistry context, QueryStrategy processInstanceQueriesStrategy) {
