...
public class ProcessInstanceQueryServiceBaseTest {
	...
	public void testGetProcessInstancesTasksWithFilters() {
		...
		ProcessInstanceQueryServiceBase base = new ProcessInstanceQueryServiceBase(queryServiceMock, contextMock, processInstanceQueriesStrategyMock);
