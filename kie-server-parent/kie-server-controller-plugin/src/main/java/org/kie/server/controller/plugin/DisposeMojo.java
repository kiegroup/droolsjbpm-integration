...
@Mojo( name = "dispose", defaultPhase = LifecyclePhase.DEPLOY, threadSafe = true, requiresProject = false)
public class DisposeMojo extends KieControllerAbstractMojo {
    ...
    public void executeCommand() throws MojoExecutionException, MojoFailureException {
        ...
        if (container == null && project == null) {
            throw new MojoFailureException("Unable to find containerSpec name");
