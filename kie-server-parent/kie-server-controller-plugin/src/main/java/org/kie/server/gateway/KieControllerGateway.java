...
public class KieControllerGateway {
    ...
    public KieControllerGateway(String protocol, String hostname, Integer port, String username, String password, Integer connectionTimeout, Integer socketTimeout, String contextPath) {

        targetUrl = new StringBuilder(protocol)
            .append("://").append(hostname)
            .append(":").append(port)
            .append("/").append(contextPath)
            .append("/rest/controller")
            .toString();
    ...
    public void createContainer(String templateId, String containerId, ContainerSpec containerSpec) {
        ...
        JSONMarshaller jsonMarshaller = new JSONMarshaller(classes, Thread.currentThread().getContextClassLoader());
