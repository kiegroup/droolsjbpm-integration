 ...
 */
@Mojo( name = "stop-container", defaultPhase = LifecyclePhase.DEPLOY, threadSafe = true, requiresProject = true)
public class StopContainerMojo extends KieControllerAbstractMojo {
