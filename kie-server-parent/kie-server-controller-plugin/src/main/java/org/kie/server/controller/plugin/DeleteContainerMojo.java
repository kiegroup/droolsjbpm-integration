...
/**
 * Dispose container from server template
 */
@Mojo( name = "delete-container", defaultPhase = LifecyclePhase.DEPLOY, threadSafe = true, requiresProject = false)
public class DeleteContainerMojo extends KieControllerMojo {
    ...
    public void executeCommand() throws MojoExecutionException, MojoFailureException {
        ...
        getLog().info("Container " + container + " DELETED from server template " + templateId);
