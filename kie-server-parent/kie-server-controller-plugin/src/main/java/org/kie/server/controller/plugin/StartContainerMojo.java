 ...
 */
@Mojo( name = "start-container", defaultPhase = LifecyclePhase.DEPLOY, threadSafe = true, requiresProject = false)
public class StartContainerMojo extends KieControllerMojo {
