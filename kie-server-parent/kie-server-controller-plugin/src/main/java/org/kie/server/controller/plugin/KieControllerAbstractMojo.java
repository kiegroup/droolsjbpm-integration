...
public abstract class KieControllerAbstractMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        getLog().info("Controller Password: ###SECRET###");
        getLog().info("Connection Timeout: " + connectionTimeout);
        getLog().info("Socket Timeout: " + socketTimeout);
        getLog().info("Context Path: " + contextPath);

        kieControllerGateway = new KieControllerGateway(protocol, hostname, port, controllerUsername, controllerPassword, connectionTimeout, socketTimeout, contextPath);
