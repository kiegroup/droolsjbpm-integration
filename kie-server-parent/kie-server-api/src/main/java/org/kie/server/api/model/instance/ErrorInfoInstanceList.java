...
public class ErrorInfoInstanceList {
    ...
    public ErrorInfoInstanceList(ErrorInfoInstance[] errorInfoInstances) {
        this.errorInfoInstances = errorInfoInstances;
    }

    public ErrorInfoInstanceList(List<ErrorInfoInstance> errorInfoInstances) {
        this.errorInfoInstances = errorInfoInstances.toArray(new ErrorInfoInstance[errorInfoInstances.size()]);
    }

    public ErrorInfoInstance[] getErrorInfoInstances() {
        return errorInfoInstances;
    }
