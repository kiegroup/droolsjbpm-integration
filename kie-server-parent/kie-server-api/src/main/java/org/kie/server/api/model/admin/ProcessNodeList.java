...
public class ProcessNodeList implements ItemList<ProcessNode> {
    ...
    public ProcessNodeList(ProcessNode[] processNodes) {
        this.processNodes = processNodes;
    }

    public ProcessNodeList(List<ProcessNode> processNodes) {
        this.processNodes = processNodes.toArray(new ProcessNode[processNodes.size()]);
    }
    ...
    public List<ProcessNode> getItems() {
        ...
        return Arrays.asList(processNodes);
    }
}
