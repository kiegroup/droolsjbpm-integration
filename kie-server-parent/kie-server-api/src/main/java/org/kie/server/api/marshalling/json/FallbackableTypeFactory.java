...
public class FallbackableTypeFactory extends TypeFactory {
    ...
    protected final ClassLoader _fallbackClassLoader;

    protected final static FallbackableTypeFactory instance = new FallbackableTypeFactory();

    private FallbackableTypeFactory() {
        super(null);
        _fallbackClassLoader = null;
    }
    ...
    public FallbackableTypeFactory withModifier(TypeModifier mod) {
        ...
        return new FallbackableTypeFactory(typeCache, _parser, mods, _classLoader, _fallbackClassLoader);
    }
    ...
    public FallbackableTypeFactory withClassLoader(ClassLoader classLoader) {
        return new FallbackableTypeFactory(_typeCache, _parser, _modifiers, classLoader, _fallbackClassLoader);
    }
    ...
    public FallbackableTypeFactory withCache(LRUMap<Object, JavaType> cache) {
        return new FallbackableTypeFactory(cache, _parser, _modifiers, _classLoader, _fallbackClassLoader);
    }
    ...
    public Class<?> findClass(String className) throws ClassNotFoundException {
        try {
            ...
            if (_fallbackClassLoader != null) {
                Throwable prob = null;
                try {
                    return classForName(className, true, _fallbackClassLoader);
                } catch (Exception e1) {
