...
public class WebSocketKieServerControllerClientImpl extends Endpoint implements WebSocketKieServerControllerClient {

    private static final Logger LOGGER = LoggerFactory.getLogger(WebSocketKieServerControllerClientImpl.class);
    ...
    private Consumer<WebSocketKieServerControllerClientImpl> onReconnect;

    public WebSocketKieServerControllerClientImpl() {
        super();
    }

    public WebSocketKieServerControllerClientImpl(final Consumer<WebSocketKieServerControllerClientImpl> onReconnect) {
        this();
