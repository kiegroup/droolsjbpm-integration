...
public class KieServerControllerNotificationMessageHandlerTest {
    ...
    public void testConsumerExecuted(){
        ...
        KieServerControllerNotificationMessageHandler handler = new KieServerControllerNotificationMessageHandler(consumer);

        final KieServerControllerNotification message = mock(KieServerControllerNotification.class);
