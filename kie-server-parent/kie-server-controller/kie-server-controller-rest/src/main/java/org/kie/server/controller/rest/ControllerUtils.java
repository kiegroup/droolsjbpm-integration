...
public class ControllerUtils {
    ...
    public static String getUser() {
        return System.getProperty(KieServerConstants.CFG_KIE_CONTROLLER_USER, "kieserver");
    }

    public static String getPassword() {
        return System.getProperty(KieServerConstants.CFG_KIE_CONTROLLER_PASSWORD, "kieserver1!");
    }
}
