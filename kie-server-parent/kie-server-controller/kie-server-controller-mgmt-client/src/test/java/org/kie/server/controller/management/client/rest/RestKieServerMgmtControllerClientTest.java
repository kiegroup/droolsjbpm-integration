...
public class RestKieServerMgmtControllerClientTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(RestKieServerMgmtControllerClientTest.class);

    @Parameterized.Parameter
    public MarshallingFormat marshallingFormat;
    private RestKieServerMgmtControllerClient client;
    ...
    @Before
    public void before() {
        client = new RestKieServerMgmtControllerClient(null,
                                                       null,
                                                       null,
                                                       marshallingFormat);
    }
