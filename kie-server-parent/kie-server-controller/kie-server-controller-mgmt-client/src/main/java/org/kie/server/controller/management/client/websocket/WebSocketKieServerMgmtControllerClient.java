...
package org.kie.server.controller.management.client.websocket;
...
import org.kie.server.controller.websocket.common.WebSocketKieServerControllerClient;
...
public class WebSocketKieServerMgmtControllerClient implements KieServerMgmtControllerClient {

    private static final Logger LOGGER = LoggerFactory.getLogger(WebSocketKieServerMgmtControllerClient.class);

    private WebSocketKieServerControllerClient client;

    public WebSocketKieServerMgmtControllerClient(final String controllerUrl,
        ...
        this(controllerUrl,
             ...
             password,
             token,
             new WebSocketKieServerControllerClientImpl());
    }
    ...
    public WebSocketKieServerMgmtControllerClient(final String controllerUrl,
                                                  ...
                                                  final String password,
                                                  final String token,
                                                  final WebSocketKieServerControllerClient client) {
        this.client = client;
