...
public class RuleRelatedProcessIntegrationTest extends JbpmKieServerBaseIntegrationTest {
    ...
    public void testProcessWithBusinessRuleTask() throws Exception {
        ...
        Long processInstanceId = processClient.startProcess("definition-project", "business-rule-task");
        ...
        try {
            ...
            BatchExecutionCommand executionCommand = commandsFactory.newBatchExecution(commands, "definition-project"); // use container id as ksession id to use ksession from jBPM extension
            ...
            executionCommand = commandsFactory.newBatchExecution(commands, "definition-project"); // use container id as ksession id to use ksession from jBPM extension
    ...
    public void testProcessWithConditionalEvent() throws Exception {
        ...
        assertSuccess(client.createContainer("definition-project", new KieContainerResource("definition-project", releaseId)));
        Long processInstanceId = processClient.startProcess("definition-project", "conditionalevent");
        assertNotNull(processInstanceId);
        assertTrue(processInstanceId.longValue() > 0);
        try {
            List<TaskSummary> taskList = taskClient.findTasksAssignedAsPotentialOwner("yoda", 0, 10);
