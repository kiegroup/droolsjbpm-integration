...
public class RuleTemplateIntegrationTest extends DroolsKieServerBaseIntegrationTest {
    ...
    private static ReleaseId releaseId = new ReleaseId("org.kie.server.testing", "template-project", "1.0.0");
    ...
    public static void buildAndDeployArtifacts() {
        ...
        KieServerDeployer.buildAndDeployMavenProjectFromResource("/kjars-sources/template-project");
