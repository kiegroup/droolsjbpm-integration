...
import org.kie.server.client.impl.CustomExtensionClientRest;

public class CustomExtensionClientBuilder implements KieServicesClientBuilder {
    ...
    public Map<Class<?>, Object> build(KieServicesConfiguration configuration, ClassLoader classLoader) {
        ...
        if(configuration.isRest()) {
            services.put(CustomExtensionClient.class, new CustomExtensionClientRest(configuration, classLoader));
        }
