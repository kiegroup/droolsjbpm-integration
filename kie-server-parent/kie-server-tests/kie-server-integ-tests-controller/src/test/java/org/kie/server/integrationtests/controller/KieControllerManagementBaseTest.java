...
public abstract class KieControllerManagementBaseTest extends RestOnlyBaseIntegrationTest {
    ...
    protected ContainerSpec createContainerSpec(ServerTemplate serverTemplate) {
        return createContainerSpec(serverTemplate, RELEASE_ID, KieContainerStatus.STOPPED);
    }

    protected ContainerSpec createContainerSpec(ServerTemplate serverTemplate, ReleaseId releaseId) {
        return createContainerSpec(serverTemplate, releaseId, KieContainerStatus.STOPPED);
    }
