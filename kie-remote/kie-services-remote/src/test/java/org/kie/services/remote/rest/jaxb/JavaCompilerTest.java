...
public class JavaCompilerTest {
    ...
    public static Class getClassFromSource(String fileName) throws Exception { 
        ...
        File sourceFile = new File(root, "org/kie/services/remote/rest/jaxb/MyType.java");
        ...
        Class<?> cls = Class.forName("org.kie.services.remote.rest.jaxb.MyType", true, classLoader); 
