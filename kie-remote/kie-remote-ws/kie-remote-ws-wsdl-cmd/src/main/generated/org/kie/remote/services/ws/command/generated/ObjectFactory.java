...
public class ObjectFactory {
    ...
    private final static QName _CommandServiceException_QNAME = new QName("http://services.remote.kie.org/6.2.0.1/command", "CommandServiceException");
    private final static QName _CommandRequest_QNAME = new QName("http://services.remote.kie.org/6.2.0.1/command", "command-request");
    private final static QName _ExecuteResponse_QNAME = new QName("http://services.remote.kie.org/6.2.0.1/command", "executeResponse");
    private final static QName _CommandResponse_QNAME = new QName("http://services.remote.kie.org/6.2.0.1/command", "command-response");
    private final static QName _Execute_QNAME = new QName("http://services.remote.kie.org/6.2.0.1/command", "execute");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.remote.kie.org/6.2.0.1/command", name = "CommandServiceException")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.remote.kie.org/6.2.0.1/command", name = "command-request")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.remote.kie.org/6.2.0.1/command", name = "executeResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.remote.kie.org/6.2.0.1/command", name = "command-response")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.remote.kie.org/6.2.0.1/command", name = "execute")
