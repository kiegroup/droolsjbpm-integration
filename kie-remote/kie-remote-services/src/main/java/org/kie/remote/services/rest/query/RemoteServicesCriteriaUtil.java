...
public class RemoteServicesCriteriaUtil {
    ...
    public static <Q> Predicate createJoinedAuditPredicateFromSingleCriteria(CriteriaQuery<Q> query, CriteriaBuilder builder, QueryCriteria criteria, Attribute attr) { 
        String listId = criteria.getListId();
        if( varInstLogSpecificCriterias.contains(listId) ) { 
    ...
    public static <Q> Predicate createJoinedTaskPredicateFromSingleCriteria(CriteriaQuery<Q> query, CriteriaBuilder builder, QueryCriteria criteria, Attribute attr) {
        String listId = criteria.getListId();
        if( taskSpecificCriterias.contains(listId) ) { 
