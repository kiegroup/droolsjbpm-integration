...
public class JaxbContextResolverTest {
    ...
    public void before() throws URISyntaxException {
       ...
       dynamicJaxbContextManager.deploymentInfoBean = mockDepInfoBean;
    }
    ...
    private void undeploy(String deploymentid) {
        dynamicJaxbContextManager.cleanUpOnUndeploy(new DeploymentProcessedEvent(deploymentid));
    ...
    private void addClassesToDeploymentAndInitializeDeploymentJaxbContext(String deploymentId, Class<?>... clazz) {
       ...
       dynamicJaxbContextManager.setupDeploymentJaxbContext(new DeploymentProcessedEvent(deploymentId));
    }
