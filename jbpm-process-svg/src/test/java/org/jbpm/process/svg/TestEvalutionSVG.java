...
public class TestEvalutionSVG {
    ...
    @Test
    public void testForcedSVGWidthHeight() throws Exception {
        String svgWidth = "600px";
        ...
        String svg = SVGImageProcessor.transform(TestEvalutionSVG.class.getResourceAsStream("/evaluation-svg.svg"),
                                                 ...
                                                 "#888887", "#888886", svgWidth, svgHeight);

        Document svgDocument = readSVG(svg);
        assertEquals(svgWidth, svgDocument.getFirstChild().getAttributes().getNamedItem("width").getNodeValue());
        assertEquals(svgHeight, svgDocument.getFirstChild().getAttributes().getNamedItem("height").getNodeValue());

        svg = SVGImageProcessor.transform(TestEvalutionSVG.class.getResourceAsStream("/evaluation-svg.svg"),
                                          completed, active, null, "#888888",
                                          "#888887", "#888886", "", "");
        svgDocument = readSVG(svg);
        assertEquals("3000", svgDocument.getFirstChild().getAttributes().getNamedItem("width").getNodeValue());
        assertEquals("2000", svgDocument.getFirstChild().getAttributes().getNamedItem("height").getNodeValue());
    }
