    ...
    protected AbstractBeanDefinition parseInternal(Element element, ParserContext parserContext) {
        ...
        if ( "fileLogger".equalsIgnoreCase(element.getLocalName())) {
            ...
            if (threadedStr != null && Boolean.valueOf(threadedStr)) {
                factory.addPropertyValue(LOGGER_ATTRIBUTE_LOGGER_TYPE, KnowledgeLoggerAdaptor.KNOWLEDGE_LOGGER_TYPE.LOGGER_TYPE_THREADED_FILE);
                ...
                factory.addPropertyValue(LOGGER_ATTRIBUTE_LOGGER_TYPE, KnowledgeLoggerAdaptor.KNOWLEDGE_LOGGER_TYPE.LOGGER_TYPE_FILE);
            }
        } else if ("consoleLogger".equalsIgnoreCase(element.getLocalName())) {
            factory.addPropertyValue(LOGGER_ATTRIBUTE_LOGGER_TYPE, KnowledgeLoggerAdaptor.KNOWLEDGE_LOGGER_TYPE.LOGGER_TYPES_CONSOLE);
        }
